...
const boutique = {
  ...
  <table>
    <thead>
      <tr>
        <td><p class="lsh_panier_apparent">Votre panier est de {{this.total}} €</p>
        <button @click.prevent="show=!show" class="submit-button">Acheter</button></td>
        <td><h1>Titre: </h1></td>
        <td><h1>Prix: </h1></td>
      </tr>
    </thead>
